...
struct DashLavaDark: Codable, Equatable {
    ...
    /// ★ T's device-dialed DARK values, RE-BAKED 2026-09-25 (Brief AZ1) from his Copy. sharedField ON;
    /// blob 2 dialed BACK IN (peak 0.712, moved to originX 0, bigger + brighter). Copy-dump verbatim.
    static let `default` = DashLavaDark(
        blobs: [
            ...
            DashLavaDarkBlob(originX: 0, originY: 0.22, radius: 0.9738095521926878, speedX: 0.00016, speedY: 0.00026,
                             phase: 0, color: DashLavaRGB(r: 0, g: 0.337249755859375, b: 0.839202880859375), peak: 0.7121211886405945),
